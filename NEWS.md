...
* Implement support for markdown and LaTex equations embedded in markdown. This only works for methods.md templates. This addresses [issue #85](https://github.com/EDIorg/EMLassemblyline/issues/85).
